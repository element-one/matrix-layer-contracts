...
async function main() {
  ...
  const matrixPhoneAddress = await deployContract('MatrixNFT', ['Phone', 'Phone', deployer.address], 'MatrixPhone')
  const matrixAddress = await deployContract('MatrixNFT', ['Matrix', 'MTX', deployer.address], 'Matrix')
